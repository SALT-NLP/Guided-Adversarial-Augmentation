...
parser.add_argument("--augmented-train-percentage", default = 0.05, type = int)
...
def main():
    ...
    config = config_class.from_pretrained(
        ...
        num_labels=num_labels,hidden_dropout_prob=0.5
    )
    ...
    if args.do_train:
        ...
        if args.train_mode =="rulebasedaug" :
            ...
            train_dataset = read_data(args, tokenizer, labels, pad_token_label_id, mode = 'train', pad_subtoken_with_real_label=args.pad_subtoken_with_real_label)
